...
#	print $pit . PHP_EOL;
	$db->query("INSERT INTO tmp_fish (capture_date, river, section, fishec, species_code, standard_length, total_length, weight, pit_id, comments, fish_origin, hatchery, parental_origin, sex, ripeness, recapture, laketrout, original_site_name) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)", [ $ymd, $river, $section, $fishec, $species, $sl, $tl, $weight, $pit, $comments, $fish_origin, $hatchery, $parental_origin, $sex, $ripeness, $recapture, $laketrout, $original_site_name ] );
